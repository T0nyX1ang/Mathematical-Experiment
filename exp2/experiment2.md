...
## Binary
You can download the binaries generated by MATLAB&copy; Compiler here. Before you run the binaries, you need to **read the README.txt** in our files first.
...
### Important Notice:
We are sorry to tell you that it's not possible to compile a symbolic toolbox function with mcc. So you can only use **basic, matrix** module, plotting with **unsaved** function_handle variables, and saving data **without** function_handles. You **can't** use any function features with symbolic toolbox. 

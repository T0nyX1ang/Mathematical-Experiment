...
Please note that MATLAB&copy; runtime is needed on **all** platforms, you can download from [here](https://ww2.mathworks.cn/products/compiler/matlab-runtime.html). As the whole project is compiled on MATLAB&copy; R2018a, you need to download the right runtime on your platform.

In order to contain all the contents needed, we zipped our binaries and other sufficient contents in one `zip` file.

### Windows Binary
The windows binary can be downloaded [here], please verify the hash codes before you run this program.

...
Please note that MATLAB(R) runtime is needed on all platforms, you can download from [here](https://ww2.mathworks.cn/products/compiler/matlab-runtime.html). As the whole project is compiled on MATLAB(R) R2018a, you need to download the right runtime on your platform.
